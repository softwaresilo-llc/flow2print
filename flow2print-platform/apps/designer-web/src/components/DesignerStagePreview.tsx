...
const renderShapeContent = (layer: DesignerLayer, scale: number) => {
      ...
      <div className="stage-preview__divider">
        <span
          ...
          style={{
            ...
            height: `${Math.max(2, Math.min(3, layer.height * scale * 0.8))}px`
          }}
        />
      </div>
    );
  ...
  return (
    ...
    >
      <div className="stage-preview__layer-inner">
        ...
        {layer.type === "shape" ? renderShapeContent(layer, scale) : null}
